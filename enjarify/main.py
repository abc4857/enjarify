...
def translate(data, opts, classes=None, errors=None, allowErrors=True, printNames=False, skipAndroid=False):
    ...
    for cls in dex.classes:
        ...
        if skipAndroid and unicode_name.startswith('android/'):
            continue
...
def main():
    ...
    parser.add_argument('--debug', action='store_true', help='Translate debug info (line numbers and local variable names and types). Run with --fast to avoid losing information (variables may be deleted during optimization)')
    parser.add_argument('--classnames', action='store_true', help='Print class names while translating')
    parser.add_argument('--skipandroid', action='store_true', help='Skip classes in the android.* package')
    ...
    if args.debug:
        opts.translate_debug = True
    classes = collections.OrderedDict()
    errors = collections.OrderedDict()
    for data in dexs:
        translate(data, opts=opts, classes=classes, errors=errors, printNames=args.classnames, skipAndroid=args.skipandroid)
